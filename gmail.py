...
def settings():
    ...
    root1.config(bg='floral white')

    Label(root1,text='Credential Settings',image=logoImage,compound=LEFT,font=('goudy old style',40,'bold'),
          fg='red3',bg='floral white').grid(padx=60)

    fromLabelFrame = LabelFrame(root1, text='From (Email Address)', font=('times new roman', 16, 'bold'), bd=5, fg='red3',bg='floral white')
    ...
    passwordLabelFrame = LabelFrame(root1, text='Password', font=('times new roman', 16, 'bold'), bd=5,fg='red3',bg='floral white')
...
root = Tk()
root.title("Email sender app by Devangi Parmar")
root.geometry('780x620+100+50')
root.resizable(0,0)
root.config(bg='floral white')

titleFrame = Frame(root,bg='floral white')
titleFrame.grid(row=0, column=0)

logoImage = PhotoImage(file='email.png')
titleLabel = Label(titleFrame, text='  Email Sender', image=logoImage, compound=LEFT, bg='floral white', font=('Goudy old style',28,'bold'), fg='red3')
titleLabel.grid(row=0, column=0)

settingImage = PhotoImage(file='settings.png')
Button(titleFrame, image=settingImage, bd=0, bg='floral white',cursor="hand2", activebackground='floral white', command=settings).grid(row=0, column=1, padx=20)

chooseFrame = Frame(root, bg='floral white')
...
singleRadioButton=Radiobutton(chooseFrame,text='Single',font=('times new roman',25,'bold')
                              ,variable=choice,value='single',bg='floral white',fg='red3',activebackground='floral white',
...
multipleRadioButton=Radiobutton(chooseFrame,text='Multiple',font=('times new roman',25,'bold')
                              ,variable=choice,value='multiple',bg='floral white',fg='red3',activebackground='floral white',
                                command=button_check)
...
toLabelFrame = LabelFrame(root, text='To (Email Address)', font=('times new roman', 16, 'bold'), bd=5, fg='red3',bg='floral white')
...
browseButton =Button(toLabelFrame, text=' Browse', image=browseImage,compound=LEFT, font=('arial', 12, 'bold'), bg='floral white', fg='red3',cursor='hand2', bd=0, activebackground='floral white', state=DISABLED, command=browse)
browseButton.grid(row=0,column=1,padx=20)


subjectLabelFrame = LabelFrame(root, text='Subject', font=('times new roman', 16, 'bold'), bd=5, fg='red3',bg='floral white')
...
emailLabelFrame = LabelFrame(root, text='Compose Email', font=('times new roman', 16, 'bold'), bd=5, fg='red3',bg='floral white')
emailLabelFrame.grid(row=4, column=0, padx=20)

micImage = PhotoImage(file='mic.png')
Button(emailLabelFrame, text=' Speak', image=micImage,compound=LEFT, font=('arial', 12, 'bold'), bg='floral white', fg='red3',cursor='hand2', bd=0, activebackground='floral white', activeforeground='red3', command=speak).grid(row=0,column=0)

attachImage = PhotoImage(file='attachments.png')
Button(emailLabelFrame, text=' Attachment', image=attachImage,compound=LEFT, font=('arial', 12, 'bold'), bg='floral white', fg='red3',cursor='hand2', bd=0, activebackground='floral white', activeforeground='red3', command=attachment).grid(row=0,column=1)
...
Button(root,image=sendImage,compound=LEFT,  bg='floral white', fg='red3',cursor='hand2', bd=0,activebackground='floral white', activeforeground='red3', command=send_email).place(x=490, y=540)

clearImage = PhotoImage(file='clear.png')
Button(root,image=clearImage,compound=LEFT,  bg='floral white', fg='red3',cursor='hand2', bd=0,activebackground='floral white', activeforeground='red3', command=clear).place(x=590, y=540)

exitImage = PhotoImage(file='exit.png')
Button(root,image=exitImage,compound=LEFT,  bg='floral white', fg='red3',cursor='hand2', bd=0,activebackground='floral white', activeforeground='red3', command=iexit).place(x=690, y=540)

totalLabel=Label(root,font=('times new roman',18,'bold'),bg='floral white',fg='red3')
totalLabel.place(x=10,y=560)

sentLabel=Label(root,font=('times new roman',18,'bold'),bg='floral white',fg='red3')
sentLabel.place(x=100,y=560)

leftLabel=Label(root,font=('times new roman',18,'bold'),bg='floral white',fg='red3')
leftLabel.place(x=190,y=560)

failedLabel=Label(root,font=('times new roman',18,'bold'),bg='floral white',fg='red3')
